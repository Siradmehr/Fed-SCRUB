    ...
    def _make_layers(self):
        ...
        for i in range(self.num_layer - 2):
            layer += [StandardLinearLayer(self.hidden_size,
                                          self.hidden_size)]  # [nn.Linear(self.hidden_size, self.hidden_size)]
            # layer += [Affine(self.hidden_size)]
            layer += [nn.ReLU()]
        layer += [
            StandardLinearLayer(self.hidden_size, self.num_classes)]  # [nn.Linear(self.hidden_size, self.num_classes)]
